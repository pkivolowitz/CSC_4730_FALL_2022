# CSC 4730 Project 2 - Stride Scheduler
...
execute. It is an error if the file is not given or cannot be opened for
reading.
...
A new job is entered into the system. Its name and priority are given.
...
Unblocked jobs return to the runnables. The scheduler is not run unless
the system was idle.
...
you are given, you have a reasonable chance of a high score but this is
not a certainty. Do not be complacent... make your own tests!
